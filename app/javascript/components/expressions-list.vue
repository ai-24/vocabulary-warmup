<template>
  <ul
    class="expressions-list h-auto max-h-80 overflow-x-auto overflow-y-auto border border-lavender-600">
    <li
      v-for="expressionsResource in expressionsResources"
      :key="expressionsResource.id"
      class="expression">
      <a
        class="block py-2 px-3 bg-white border-b border-lavender-600 hover:bg-lavender-50 font-medium"
